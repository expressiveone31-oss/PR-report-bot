...
- col_post_url: колонка со ссылкой непосредственно на публикацию (не на канал)
- col_channel_url: колонка со ссылкой на канал/профиль
- col_planned_reach: плановый/ожидаемый охват
- col_actual_reach: фактический/реальный охват
- col_cost: стоимость/цена размещения (бюджет конкретного поста)
